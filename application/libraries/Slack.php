...
class Slack
{
    ...
    public $endpoint = 'https://hooks.slack.com/services/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';
    //Default icon
    public $icon = ':ghost:';
    //Default username
    public $username = 'config-slack-bot';
    //Default channel to post to
    public $channel = 'nimes1_community';
    ...
    private function _communicate($data) {
        ...
        $result = curl_exec($ch); //renvoie false si problème sinon true
        curl_close($ch);
